...
from .poker_game_long import LongPokerGameEventDispatcher, LongPokerGame
from .score_detector import CustomPokerScoreDetector


class CustomPokerGameFactory(GameFactory):
    ...
    def create_game(self, players: List[Player]):
        ...
        return LongPokerGame(
            ...
            score_detector=CustomPokerScoreDetector(lowest_rank)
        )
